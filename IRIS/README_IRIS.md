...
Key libraries used include NumPy, Pandas, Matplotlib, Seaborn, and Scikit-learn (Naive Bayes classifiers).
A great beginner-friendly project demonstrating a complete ML classification pipeline.
